  ...
  return (
    <div className="rcpn-page">
      <SEO
        ...
        description="Política de privacidade e proteção de dados pessoais do Cartório do 3º Distrito de Maricá-RJ, em conformidade com a Lei Geral de Proteção de Dados (LGPD)."
        path="/lgpd"
      />
      <h1 className="page-main-title reveal">Proteção de Dados e LGPD</h1>
      ...
      <section className="content-section reveal">
        ...
        <p>
          A LGPD – Lei Geral de Proteção de Dados, foi aprovada em agosto de
          2018 no Brasil e impôs regras sobre o tratamento de dados pessoais. A
          normativa tem como finalidade proteger o direito à liberdade,
      ...
      <section className="content-section reveal">
        ...
        <p>
          ...
          notariais e de registro foram equiparados às pessoas jurídicas de
          direito público.
        </p>
      </section>
      ...
      <section className="content-section reveal">
        ...
        <p>
          O artigo 26 determina que o uso compartilhado de dados pessoais deve
          atender às finalidades específicas de execução de políticas públicas.
        </p>
      </section>
      ...
      <section className="content-section reveal">
        ...
        <div className="warning-box">
          <p style={{ margin: 0 }}>
            É vedada a transferência de dados a entidades privadas, salvo nas
            hipóteses legais.
          </p>
        </div>
      </section>
      ...
      <section className="content-section reveal">
        ...
        <div className="info-box">
          ...
          <p style={{ margin: 0 }}>✉️ cartorio3marica@gmail.com</p>
        </div>
      </section>
      ...
      >
        ...
        <p style={{ color: 'var(--text-secondary)', marginBottom: '24px' }}>
          Para exercer seus direitos, encaminhe solicitação formal acompanhada
