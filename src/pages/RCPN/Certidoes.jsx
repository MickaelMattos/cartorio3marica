...
export default function Certidoes() {
  return (
    <>
      <SEO
        title="Certidões"
        description="Solicite certidões de nascimento, casamento e óbito no Cartório do 3º Distrito de Maricá-RJ. Emissão física e online, inteiro teor e resumo em Inoã, Maricá/RJ."
        path="/rcpn/certidoes"
      />
      <section className="content-section">
        ...
        <p>
          ...
          os assentos registrados nos livros do Registro Civil das Pessoas
          Naturais, dotadas de fé pública e eficácia probatória.
        </p>
        <p>
          São essenciais para comprovação de situação jurídica e prática de
      ...
      <section className="content-section">
        ...
        <p>
          Reproduz <strong>integralmente</strong> o conteúdo do assento de
          registro, incluindo todas as anotações, averbações e dados constantes
          no livro.
        </p>
        <p>
        ...
        <ul>
          <li>
            Quando é necessário comprovar todas as informações do registro
          </li>
        ...
        <p>
          Comprova o nascimento e a filiação da pessoa, bem como eventuais
          averbações (casamento, divórcio, emancipação, etc.).
        </p>
        <p>
        ...
        <p>
          Comprova o falecimento de uma pessoa, com informações sobre data,
          hora, local e causa da morte.
        </p>
        <p>
          <strong>Uso comum:</strong>
        </p>
      ...
      <section className="content-section">
        ...
        <div className="success-box">
          ...
          <ul>
            ...
            <li>
              Certidão para pessoas reconhecidamente pobres (mediante
              declaração)
            </li>
          </ul>
        </div>
      ...
      <section className="content-section">
        ...
        <p>
          De acordo com a legislação vigente, as certidões não possuem prazo de
          validade fixo, exceto quando estabelecido expressamente pelo órgão
          requisitante.
        </p>
        ...
        <ul>
          <li>
            <strong>Concursos públicos:</strong> geralmente 90 dias
          </li>
          <li>
            <strong>Casamento:</strong> certidão de nascimento sem prazo;
            certidão de casamento com divórcio até 180 dias
          </li>
          <li>
            <strong>Processos judiciais:</strong> conforme determinação do juiz
          </li>
          <li>
            <strong>Transações imobiliárias:</strong> até 90 dias
          </li>
        </ul>

        <div className="info-box">
          <p>
            <strong>Importante:</strong> Sempre verifique com o órgão
            solicitante qual o prazo de validade aceito para a certidão.
          </p>
        </div>
      </section>
      ...
      <section className="content-section">
        ...
        <ul>
          <li>
            Comparecer ao Cartório de Registro Civil onde foi feito o registro
          </li>
          <li>
            Informar os dados da pessoa (nome completo, data do evento, nome dos
            pais)
          </li>
        ...
        <h3 className="section-subtitle">
          Online (Portal Nacional de Certidões)
        </h3>
        <p>
          Através do site <strong>www.registrocivil.org.br</strong>, é possível
          solicitar certidões de nascimento, casamento e óbito de todo o Brasil.
        </p>
        <p>
      ...
      <section className="content-section">
        ...
        <p>
          As certidões digitais emitidas pelo Portal Nacional ou pelos cartórios
          possuem:
        </p>
        <ul>
          <li>
            <strong>QR Code</strong> para verificação de autenticidade
          </li>
          <li>
            <strong>Assinatura eletrônica</strong> do registrador
          </li>
          <li>
            <strong>Validade jurídica</strong> equivalente à certidão física
          </li>
          <li>
            <strong>Possibilidade de impressão</strong> em papel comum
          </li>
        </ul>
      ...
      <section className="content-section">
        ...
        <p>Certidões de pessoas falecidas podem ser solicitadas por:</p>
        <ul>
      ...
      <section className="content-section">
        ...
        <p>
          A certidão negativa atesta a <strong>inexistência</strong> de registro
          em determinado período ou para determinada pessoa.
        </p>
        <p>
      ...
      <section className="content-section">
        <h2 className="section-title">
          Apostilamento de Certidões (Apostila de Haia)
        </h2>
        <p>
        ...
        <p>
          <strong>Onde fazer:</strong>
        </p>
        <ul>
          <li>Cartórios de Notas autorizados</li>
          <li>
            Alguns Cartórios de Registro Civil (conforme regulamentação local)
          </li>
        </ul>
      </section>
      ...
      <section className="content-section">
        ...
        <p>
          Se houver erros ou informações incorretas na certidão, é possível
          solicitar:
        </p>
        <ul>
          <li>
            <strong>Retificação administrativa:</strong> para erros materiais
            evidentes, diretamente no cartório
          </li>
          <li>
            <strong>Retificação judicial:</strong> para alterações substanciais,
      ...
      <section className="content-section">
        ...
        <p>
          A segunda via de certidão pode ser solicitada a qualquer momento,
          mediante:
        </p>
        <ul>
        ...
        <p>
          A segunda via reproduz fielmente o registro, incluindo todas as
          averbações realizadas até a data da expedição.
        </p>
      </section>
      ...
      <section className="content-section">
        ...
        <ul>
          <li>
            As certidões devem ser apresentadas em bom estado de conservação
          </li>
          <li>
            Certidões danificadas ou ilegíveis podem ser recusadas pelos órgãos
          </li>
          <li>
            É recomendável sempre conferir os dados antes de solicitar a
            certidão
          </li>
          <li>
            Documentos em língua estrangeira necessitam de tradução juramentada
          </li>
        </ul>
      </section>
      ...
      <section className="content-section">
        ...
        <p>
          Lei nº 6.015/1973 (Lei de Registros Públicos), Lei nº 9.534/1997
          (Gratuidade), Provimento CNJ nº 100/2020 (Certidões Digitais), Código
          de Normas da Corregedoria Geral da Justiça e demais normas aplicáveis.
        </p>
      </section>
    </>
  )
