...
export default function Averbacoes() {
  return (
    <>
      <SEO
        title="Averbações e Anotações"
        description="Realize averbações e anotações em registros civis no Cartório do 3º Distrito de Maricá-RJ. Alteração de nome, divórcio, adoção, reconhecimento de paternidade e mais."
        path="/rcpn/averbacoes"
      />
      <section className="content-section">
        <h2 className="section-title">O que é Averbação</h2>
        <p>
          Averbação é o ato pelo qual se anota no registro civil informações
          supervenientes que modificam, complementam ou retificam dados
          constantes do assento originário, mantendo o registro atualizado.
        </p>
        <p>
      ...
      <section className="content-section">
        ...
        <h3 className="section-subtitle">
          1. Averbação de Casamento no Registro de Nascimento
        </h3>
        <p>
          Anota-se no registro de nascimento a realização do casamento,
          alterando o estado civil de solteiro para casado.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            Certidão de nascimento (para consulta do número do livro e folha)
          </li>
        </ul>
        ...
        <ul>
          <li>
            Certidão de sentença de divórcio com trânsito em julgado ou
        ...
        <p>
          Registra-se o falecimento no assento de casamento ou nascimento do
          falecido.
        </p>
        <p>
          <strong>Documentos necessários:</strong>
        ...
        <p>Incluem-se decisões judiciais que alteram o registro, tais como:</p>
        <ul>
        ...
        <ul>
          <li>
            Mandado judicial ou certidão de sentença com trânsito em julgado
          </li>
      ...
      <section className="content-section">
        ...
        <h3 className="section-subtitle">
          Averbação de Reconhecimento de Paternidade/Maternidade
        </h3>
        <p>
          Realiza-se quando há reconhecimento posterior de paternidade ou
          maternidade, seja de forma voluntária ou judicial.
        </p>
        <p>
          <strong>Documentos necessários:</strong>
        </p>
        <ul>
          <li>
            Escritura pública de reconhecimento de paternidade/maternidade, ou
          </li>
        ...
        <p>Registra a emancipação de menores entre 16 e 18 anos de idade.</p>
        <p>
          <strong>Documentos necessários:</strong>
        </p>
        <ul>
        ...
        <h3 className="section-subtitle">
          Averbação de Interdição ou Levantamento de Interdição
        </h3>
        <p>Anota-se a sentença de interdição ou seu levantamento.</p>
        <p>
          <strong>Documentos necessários:</strong>
        </p>
        <ul>
        ...
        <h3 className="section-subtitle">
          Averbação de Retificação Administrativa
        </h3>
        <p>
          Corrige erros materiais evidentes no registro (grafia, datas óbvias,
          etc.), sem necessidade de ação judicial.
        </p>
        <p>
          <strong>Documentos necessários:</strong>
        </p>
        <ul>
          ...
          <li>
            Documentos que comprovem o erro (RG, certidão de batismo, documentos
            escolares, etc.)
          </li>
      ...
      <section className="content-section">
        <h2 className="section-title">
          Averbação de Alteração de Nome por Uso Social
        </h2>
        <div className="highlight-box">
          <p>
            Conforme o Provimento CNJ nº 122/2021, é possível realizar alteração
            de prenome e sobrenome diretamente em cartório, uma única vez, sem
            necessidade de autorização judicial, desde que não prejudique
            terceiros.
          </p>
        </div>
        <p>
        ...
        <ul>
          ...
          <li>
            Provas do uso social do nome (declarações, documentos, fotos, etc.)
          </li>
        </ul>
      </section>
      ...
      <section className="content-section">
        ...
        <p>
          Conforme decisão do STF (ADI 4275) e Provimento CNJ nº 73/2018, é
          possível realizar alteração de prenome e gênero diretamente em
          cartório, independentemente de cirurgia de redesignação sexual, laudos
          médicos ou autorização judicial.
        </p>
        <p>
          <strong>Documentos necessários:</strong>
        </p>
        ...
        <div className="info-box">
          <p>
            O procedimento é sigiloso e a alteração não constará nas certidões
            futuras, exceto mediante autorização judicial ou a pedido do próprio
            interessado.
          </p>
        </div>
      </section>
      ...
      <section className="content-section">
        ...
        <p>
          Para os demais casos, aplicam-se os emolumentos previstos na tabela
          estadual vigente.
        </p>
      </section>
      ...
      <section className="content-section">
        ...
        <ul>
          <li>
            Todas as averbações são realizadas no livro originário do registro
          </li>
          <li>
            As certidões expedidas após a averbação já refletirão as alterações
          </li>
      ...
      <section className="content-section">
        ...
        <p>
          ...
          Brasileiro, Provimentos do Conselho Nacional de Justiça (CNJ nº
          73/2018, nº 122/2021), Código de Normas da Corregedoria Geral da
          Justiça e legislação específica aplicável.
        </p>
      </section>
    </>
  )
